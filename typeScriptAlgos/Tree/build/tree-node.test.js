...
describe('TreeNode', () => {
    ...
    describe('mergeTrees', () => {
        it('should merge two trees and return the merged tree', () => {
            const t1 = new tree_1.default(1, new tree_1.default(2), new tree_1.default(3));
            const t2 = new tree_1.default(1, new tree_1.default(2), new tree_1.default(3));
            const mergedTree = new tree_1.default(2, new tree_1.default(4), new tree_1.default(6));
